...
wheel `zai_telegram_mcp-0.3.0-py3-none-any.whl` plus `SHA256SUMS.txt` from [v0.3.0](https://github.com/zai-one/telegram-mcp/releases/tag/v0.3.0).
...
```sh
uv tool install "zai-telegram-mcp @ https://github.com/zai-one/telegram-mcp/releases/download/v0.3.0/zai_telegram_mcp-0.3.0-py3-none-any.whl"
zai-telegram-mcp-setup --directory /absolute/path/to/my-telegram-settings
zai-telegram-mcp --config /absolute/path/to/my-telegram-settings/mcp.local.json --check-config
```
...
Windows accepts paths such as `C:/Users/you/mcp/telegram`; quote paths containing
...
```sh
zai-telegram-mcp-setup --directory /absolute/path/to/my-telegram-settings --client-only
zai-telegram-mcp-setup --directory /absolute/path/to/my-telegram-settings --client-only --format toml
```
