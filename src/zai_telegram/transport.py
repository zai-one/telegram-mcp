...
from zai_telegram.sanitizer import SanitizerLimits, sanitize_provider_response
...
class LocalPreDispatchDenied(ProviderAdmissionDenied):
    """Standalone admission refused before entering the embedded-call factory."""
